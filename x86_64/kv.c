...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kv /home/roxanne/dev/Imbizo-project-22/mechanisms/kv.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/roxanne/dev/Imbizo-project-22/mechanisms/kv.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "kv.mod\n"
  "\n"
